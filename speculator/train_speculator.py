...
llama_160m_config = LLaMAConfig(emb_dim=768, nheads=12, nlayers=12,kvheads=12, max_expected_seq_len=2048,norm_eps=1e-06,activation_fn="silu", hidden_grow_factor = 4)
...
def main(**kwargs):
    ...
    #torch.set_grad_enabled(False) #for testing 
    #test_model(rank, model, arch, cfg) #for testing 
